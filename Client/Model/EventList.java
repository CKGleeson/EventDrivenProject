...
public class EventList {
    private static EventList instance; // Add this
    
    private ArrayList<Event> eventList = new ArrayList<>();

    
    public static EventList getInstance() { // Add this
    ...
    return alleventsondate(date);
}

public ArrayList<Event> geteventswithname(String name) {
    return alleventswithname(name);
}

public ArrayList<Event> geteventswithstarttime(LocalDateTime startTime) {
    return alleventswithstarttime(startTime);
}

public ArrayList<Event> geteventswithendtime(LocalDateTime endTime) {
    return alleventswithendtime(endTime);
}

public ArrayList<Event> geteventswithlocation(String location) {
    return alleventswithlocation(location);
}

public ArrayList<Event> geteventswithmodule(String module) {
    return alleventswithmodule(module);
}

public ArrayList<Event> geteventswithtype(String type) {
    return alleventswithtype(type);
}

public ArrayList<Event> geteventswithlecturer(String lecturer) {
    return alleventswithlecturer(lecturer);
}
